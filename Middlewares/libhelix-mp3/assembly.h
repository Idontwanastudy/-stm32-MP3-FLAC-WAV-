...
#elif defined(ARDUINO) || defined(ESP32) || defined(ESP_PLATFORM) || defined(__APPLE__) || defined(__unix__) || defined(__arm__) || defined(__ARM_ARCH)
